...
def build_interface():
    return gr.Interface(
        ...
        outputs=[
            ...
            gr.Audio(label="AI Doctor's Voice Response")
        ],
        title="AI Doctor with Vision and Voice",
        description="Speak a symptom and upload a medical image. The AI doctor will diagnose and respond using voice."
    )

# Only run locally if this file is executed directly
...
# # Function to return the Gradio Interface object
# def build_interface():
#     return gr.Interface(
#         fn=process_inputs,
#         inputs=[
